...
public class AuthController {
    ...
    public Result<Void> changePassword(@RequestBody Map<String, String> params, 
        ...
        boolean success = userService.changePassword(userId, oldPassword, newPassword, ip);
        if (!success) {
    ...
    public Result<Void> forceChangePassword(@RequestBody Map<String, String> params, HttpServletRequest request) {
        String userId = params.get("userId");
        String oldPassword = params.get("oldPassword");
        String newPassword = params.get("newPassword");
        ...
        boolean success = userService.forceChangePassword(userId, oldPassword, newPassword, ip);
        if (!success) {
            throw new BusinessException("修改密码失败，请检查原密码是否正确");
        }
        return Result.success();
    }
