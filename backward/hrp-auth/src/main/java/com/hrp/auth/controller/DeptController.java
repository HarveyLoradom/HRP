...
public class DeptController {
     ...
     */
    @GetMapping("/{deptId}")
    public Result<Dept> getById(@PathVariable("deptId") Long deptId) {
     ...
     */
    @GetMapping("/list")
    public Result<List<Dept>> getAll(@RequestParam(value = "isStop", required = false) Long isStop) {
        List<Dept> list = deptService.getAll(isStop);
    ...
    public Result<com.hrp.common.entity.PageResult<Dept>> getAllPage(
        ...
        com.hrp.common.entity.PageResult<Dept> pageResult = deptService.getAllPage(isStop, page, size);
    ...
    public Result<Dept> getByCode(@PathVariable("deptCode") String deptCode) {
    ...
    public Result<List<Dept>> getBySuperDeptCode(@PathVariable("superDeptCode") String superDeptCode) {
    ...
    public Result<String> delete(@PathVariable("deptId") Long deptId) {
    ...
    public Result<String> toggleStatus(@PathVariable("deptId") Long deptId) {
