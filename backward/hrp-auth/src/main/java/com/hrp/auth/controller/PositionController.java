...
public class PositionController {
    ...
    public Result<Position> getById(@PathVariable("positionId") Long positionId) {
    ...
    public Result<Position> getByCode(@PathVariable("positionCode") String positionCode) {
     ...
     */
    @GetMapping("/list")
    public Result<List<Position>> getAll(@RequestParam(value = "isStop", required = false) Long isStop) {
        List<Position> list = positionService.getAll(isStop);
    ...
    public Result<String> delete(@PathVariable("positionId") Long positionId) {
        try {
    ...
    public Result<String> assignUsers(@PathVariable("positionId") Long positionId, @RequestBody List<String> userIds) {
        try {
    ...
    public Result<List<User>> getUsersByPositionId(@PathVariable("positionId") Long positionId) {
