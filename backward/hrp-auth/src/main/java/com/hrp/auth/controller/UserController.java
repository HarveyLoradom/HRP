...
public class UserController {
    ...
    public Result<User> getByAccount(@PathVariable("account") String account) {
     ...
     */
    @GetMapping("/list")
    public Result<List<User>> getAll(@RequestParam(value = "isStop", required = false) Long isStop) {
        List<User> list = userService.getAll(isStop);
    ...
    public Result<List<UserWithEmployee>> getAllEmployeesWithUser(@RequestParam(value = "isStop", required = false) Long isStop) {
        List<UserWithEmployee> list = userEmployeeService.getAllEmployeesWithUser(isStop);
        return Result.success(list);
    }
    ...
    public Result<List<UserWithEmployee>> searchEmployees(@RequestParam(value = "keyword") String keyword, @RequestParam(value = "isStop", required = false) Long isStop) {
        List<UserWithEmployee> list = userEmployeeService.getEmployeesByKeyword(keyword, isStop);
        return Result.success(list);
    }
    ...
    public Result<com.hrp.common.entity.PageResult<UserWithEmployee>> getAllEmployeesWithUserPage(
        ...
        com.hrp.common.entity.PageResult<UserWithEmployee> pageResult = userEmployeeService.getAllEmployeesWithUserPage(isStop, page, size);
    ...
    public Result<com.hrp.common.entity.PageResult<UserWithEmployee>> searchEmployeesPage(
            ...
            @RequestParam(value = "page", defaultValue = "1") Long page,
            @RequestParam(value = "size", defaultValue = "10") Long size) {
        com.hrp.common.entity.PageResult<UserWithEmployee> pageResult = userEmployeeService.getEmployeesByKeywordPage(keyword, isStop, page, size);
        return Result.success(pageResult);
    }
    ...
    public Result<String> resetPassword(@PathVariable("id") String id) {
    ...
    public Result<String> unlockUser(@PathVariable("id") String id) {
    ...
    public Result<Employee> getEmployeeByCode(@PathVariable("empCode") String empCode) {
