...
public class UserRoleController {
    ...
    public Result<List<UserRole>> getByUserId(@PathVariable("userId") String userId) {
     ...
     */
    @PostMapping("/assign")
    public Result<String> assignRoles(@RequestParam(value = "userId") String userId, @RequestBody List<Long> roleIds) {
    ...
    public Result<String> removeRole(@RequestParam(value = "userId") String userId, @RequestParam(value = "roleId") Long roleId) {
    ...
    public Result<String> clearRoles(@PathVariable("userId") String userId) {
