...
public class UserTypeMenuController {
    ...
    public Result<List<UserTypeMenu>> getByUserType(@PathVariable("userType") String userType) {
     ...
     */
    @PostMapping("/assign")
    public Result<String> assignMenus(@RequestParam(value = "userType") String userType, @RequestBody List<Long> menuIds) {
    ...
    public Result<String> removeMenu(@RequestParam(value = "userType") String userType, @RequestParam(value = "menuId") Long menuId) {
    ...
    public Result<String> clearMenus(@PathVariable("userType") String userType) {
