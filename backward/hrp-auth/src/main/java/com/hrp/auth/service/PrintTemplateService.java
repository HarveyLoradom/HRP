...
public interface PrintTemplateService {
     ...
     */
    List<PrintTemplate> getByType(String templateType, Integer isActive);

    /**
     * 查询所有打印模板
     * @param isActive 启用状态：0-停用，1-启用，null-仅启用
     */
    List<PrintTemplate> getAll(Integer isActive);
     ...
     * @return 导入后的模板对象
     */
    PrintTemplate importTemplate(String jsonContent, String templateCode, String templateName, String templateType, String createUser);
}
