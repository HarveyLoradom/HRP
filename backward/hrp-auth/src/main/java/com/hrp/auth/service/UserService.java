...
public interface UserService {
     ...
     * 修改密码（带IP地址）
     */
    boolean changePassword(String userId, String oldPassword, String newPassword, String changeIp);

    /**
     * 强制修改密码（需要原密码验证）
     */
    boolean forceChangePassword(String userId, String oldPassword, String newPassword);
    
    /**
     * 强制修改密码（带IP地址）
     */
    boolean forceChangePassword(String userId, String oldPassword, String newPassword, String changeIp);
