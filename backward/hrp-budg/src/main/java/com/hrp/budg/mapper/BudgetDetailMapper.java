...
public interface BudgetDetailMapper {
    List<BudgetDetail> selectByParams(@Param("params") Map<String, Object> params);
    ...
    List<BudgetExecutionDetail> selectApplyExecutionDetails(@Param("itemId") Long itemId, @Param("subjectId") Long subjectId, @Param("applyNo") String applyNo);
}
