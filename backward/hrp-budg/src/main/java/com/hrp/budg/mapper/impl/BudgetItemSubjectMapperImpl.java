...
public class BudgetItemSubjectMapperImpl implements BudgetItemSubjectMapper {
    ...
    @Override
    public List<BudgetItem> selectItemsBySubjectId(Long subjectId) {
        return sqlSession.selectList("com.hrp.budg.mapper.BudgetItemSubjectMapper.selectItemsBySubjectId", subjectId);
    }
