...
public interface BudgetDetailService {
    PageResult<BudgetDetail> getPage(Long page, Long size, Long subjectId, String budgetYear, String categoryType, String itemName);
    ...
    List<BudgetExecutionDetail> getApplyExecutionDetails(Long itemId, Long subjectId, String applyNo);
}
