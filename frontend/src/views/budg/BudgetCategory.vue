          ...
          <div class="toolbar">
            <el-form :inline="true" :model="search1" size="small">
              ...
              <el-form-item label="状态">
                <el-select v-model="search1.isStop" placeholder="全部" clearable style="width: 120px" @change="loadLevel1">
        ...
        <el-tab-pane label="二级分类" name="LEVEL2">
          <div class="toolbar">
            <el-form :inline="true" :model="search2" size="small">
              ...
              <el-form-item label="状态">
                <el-select v-model="search2.isStop" placeholder="全部" clearable style="width: 120px" @change="loadLevel2">
                  <el-option label="启用" :value="0"></el-option>
                  <el-option label="停用" :value="1"></el-option>
                </el-select>
              </el-form-item>
...
export default {
  ...
  methods: {
    loadLevel1() {
      this.loading1 = true
      const isStop = this.search1.isStop !== null && this.search1.isStop !== '' ? this.search1.isStop : null
      getLevel1CategoriesPage(this.pagination1.page, this.pagination1.size, this.search1.budgetYear, this.search1.categoryType, isStop)
        .then(res => {
    ...
    loadLevel2() {
      this.loading2 = true
      const isStop = this.search2.isStop !== null && this.search2.isStop !== '' ? this.search2.isStop : null
      getLevel2CategoriesPage(
